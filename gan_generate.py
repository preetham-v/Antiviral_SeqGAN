...
if __name__ == '__main__':
	...
	gen.load_state_dict(torch.load('/home/preethamv/GAN/models/gen_5000.pth', map_location=torch.device('cpu')))
	dis.load_state_dict(torch.load('/home/preethamv/GAN/models/dis_5000.pth', map_location=torch.device('cpu')))
	gen.eval()
	dis.eval()
	
	a = gen.sample(num_outputs).tolist()
